    ...
    <main className="app-shell">
      <section className="hero-panel">
        <div className="hero-copy">
          ...
          <h1>Live road damage map with dummy reports for the web MVP</h1>
          <p className="hero-description">
            A citizen-facing map to explore reported potholes, cracks, broken signs, and faded
            markings before backend integration is ready.
          </p>
        </div>

        <div className="hero-level-card">
          <div className="hero-level-badge">12</div>
          <div>
            <p className="card-kicker">Current Web Map Milestone</p>
            <h2>Filtering + Statistics</h2>
          </div>
          <div className="hero-rank">
            <span>Focus</span>
            <strong>#PublicMap</strong>
          </div>
          <div className="hero-progress">
            <div className="hero-progress-bar" />
          </div>
          <p className="hero-progress-label">Dummy data now, backend-ready structure next</p>
        </div>
      </section>

      <section className="action-banner">
        <div>
          <p className="card-kicker card-kicker-light">Map overview</p>
          <h2>Explore reported damage</h2>
          <p>Use the filters to focus on severity, issue type, report age, and verification state.</p>
        </div>
        <div className="action-badge">Map</div>
      </section>
      ...
      <section className="dashboard-grid">
        <aside className="panel filters-panel">
          ...
          <div className="report-list">
            <div className="panel-heading compact">
              <div>
                <p className="card-kicker">Visible reports</p>
                <h3>{filteredReports.length} issues on the map</h3>
              </div>
            </div>
            ...
            {filteredReports.length === 0 ? (
              <div className="empty-state">
                ...
                <p>Try broadening severity, date, or damage types to repopulate the map.</p>
              </div>
            ) : (
        ...
        <section className="map-column">
          <div className="panel map-panel">
              <div className="panel-heading">
              <div>
                <p className="card-kicker">Public web map</p>
                <h3>Road damage view</h3>
              </div>
            ...
            {selectedReport ? (
              <>
                ...
                <div className="detail-content">
                  <div className="panel-heading compact">
                    <div>
                      <p className="card-kicker">Selected report</p>
              ...
              <div className="empty-state">
                ...
                <p>The map details panel updates when you click a marker or a report card.</p>
              </div>
            )}
          </div>
        </section>
